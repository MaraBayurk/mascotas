import imagen05 from "../../../../images/pic05.jpg"
import imagen06 from "../../../../images/pic06.jpg"
import imagen07 from "../../../../images/pic07.jpg"
    ...
    return(
             <section>
								...
								<section class="mini-posts">
									<article>
										<div class="image"><a href="#"><img src={imagen05} alt="" /></a></div>
										<div class="content">
									...
									<article>
										<div class="image"><a href="#"><img src={imagen06} alt="" /></a></div>
										<div class="content">
									...
									<article>
										<div class="image"><a href="#"><img src={imagen07} alt="" /></a></div>
										<div class="content">
